#Seu programa deve ler um inteiro que corresponde ao número da placa de um veículo, 
# e informar em qual dia da semana aquele veículo não deve circular.
